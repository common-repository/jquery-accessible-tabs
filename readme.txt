...
JQuery Accessible Tabs is an tab of your blog's recent posts, recent comments and archives and uses the JQuery WAI-ARIA enabled tab. Use it in a wide widget area, like the "First Footer Widget Area".
